...
const customThirdPartyGeos = [
  ...
  readGeoJson('./third_party_maps/JP-CB.geojson'),
  readGeoJson('./third_party_maps/JP-HR.geojson'),
  readGeoJson('./third_party_maps/JP-KN.geojson'),
  readGeoJson('./third_party_maps/JP-KY.geojson'),
  readGeoJson('./third_party_maps/JP-ON.geojson'),
  readGeoJson('./third_party_maps/JP-TK.geojson'),
  readGeoJson('./third_party_maps/ES-IB-FO.geojson'),
  readGeoJson('./third_party_maps/ES-IB-IZ.geojson'),
  readGeoJson('./third_party_maps/ES-IB-MA.geojson'),
  readGeoJson('./third_party_maps/ES-IB-ME.geojson'),
  readGeoJson('./third_party_maps/AUS-TAS.geojson'),
  readGeoJson('./third_party_maps/AUS-TAS-KI.geojson'),
  readGeoJson('./third_party_maps/AUS-TAS-FI.geojson'),
  readGeoJson('./third_party_maps/AUS-TAS-CBI.geojson'),
  readGeoJson('./third_party_maps/NZ-NZS.geojson'),
  readGeoJson('./third_party_maps/NZ-NZST.geojson'),
  readGeoJson('./third_party_maps/AUS-WA-RI.geojson'),
  readGeoJson('./third_party_maps/US-HI-HA.geojson'),
  readGeoJson('./third_party_maps/US-HI-MA.geojson'),
  readGeoJson('./third_party_maps/US-HI-KA.geojson'),
  readGeoJson('./third_party_maps/US-HI-KH.geojson'),
  readGeoJson('./third_party_maps/US-HI-LA.geojson'),
  readGeoJson('./third_party_maps/US-HI-MO.geojson'),
  readGeoJson('./third_party_maps/US-HI-NI.geojson'),
...
const USSimplifiedGeos = [].concat([
  ...
  readGeoJson('./third_party_maps/US_simplified/US-CAL-CISO.geojson'), //California Independent System Operator
  readGeoJson('./third_party_maps/US_simplified/US-CAL-IID.geojson'), //Imperial Irrigation District
  readGeoJson('./third_party_maps/US_simplified/US-CAL-LDWP.geojson'), //Los Angeles Department Of Water And Power
  readGeoJson('./third_party_maps/US_simplified/US-CAL-TIDC.geojson'), //Turlock Irrigation District
  readGeoJson('./third_party_maps/US_simplified/US-CAR-CPLE.geojson'), //Duke Energy Progress East
  readGeoJson('./third_party_maps/US_simplified/US-CAR-CPLW.geojson'), //Duke Energy Progress West
  readGeoJson('./third_party_maps/US_simplified/US-CAR-DUK.geojson'), //Duke Energy Carolinas
  readGeoJson('./third_party_maps/US_simplified/US-CAR-SC.geojson'), //South Carolina Public Service Authority
  readGeoJson('./third_party_maps/US_simplified/US-CAR-SCEG.geojson'), //South Carolina Electric & Gas Company
  readGeoJson('./third_party_maps/US_simplified/US-CAR-YAD.geojson'), //Alcoa Power Generating, Inc. - Yadkin Division
  readGeoJson('./third_party_maps/US_simplified/US-CENT-SPA.geojson'), //Southwestern Power Administration
  readGeoJson('./third_party_maps/US_simplified/US-CENT-SWPP.geojson'), //Southwest Power Pool
  readGeoJson('./third_party_maps/US_simplified/US-FLA-FMPP.geojson'), //Florida Municipal Power Pool
  readGeoJson('./third_party_maps/US_simplified/US-FLA-FPC.geojson'), //Duke Energy Florida Inc
  readGeoJson('./third_party_maps/US_simplified/US-FLA-FPL.geojson'), //Florida Power & Light Company
  ...
  readGeoJson('./third_party_maps/US_simplified/US-NW-AVA.geojson'), //Avista Corporation
  readGeoJson('./third_party_maps/US_simplified/US-NW-BPAT.geojson'), //Bonneville Power Administration
  readGeoJson('./third_party_maps/US_simplified/US-NW-CHPD.geojson'), //Public Utility District No. 1 Of Chelan County
  readGeoJson('./third_party_maps/US_simplified/US-NW-DOPD.geojson'), //Pud No. 1 Of Douglas County
  readGeoJson('./third_party_maps/US_simplified/US-NW-GCPD.geojson'), //Public Utility District No. 2 Of Grant County, Washington
  readGeoJson('./third_party_maps/US_simplified/US-NW-GRID.geojson'), //Gridforce Energy Management, Llc
  readGeoJson('./third_party_maps/US_simplified/US-NW-GWA.geojson'), //Naturener Power Watch, Llc (Gwa)
  readGeoJson('./third_party_maps/US_simplified/US-NW-IPCO.geojson'), //Idaho Power Company
  readGeoJson('./third_party_maps/US_simplified/US-NW-NEVP.geojson'), //Nevada Power Company
  readGeoJson('./third_party_maps/US_simplified/US-NW-NWMT.geojson'), //Northwestern Energy (Nwmt)
  readGeoJson('./third_party_maps/US_simplified/US-NW-PACE.geojson'), //Pacificorp - East
  readGeoJson('./third_party_maps/US_simplified/US-NW-PACW.geojson'), //Pacificorp - West
  readGeoJson('./third_party_maps/US_simplified/US-NW-PGE.geojson'), //Portland General Electric Company
  readGeoJson('./third_party_maps/US_simplified/US-NW-PSCO.geojson'), //Public Service Company Of Colorado
  readGeoJson('./third_party_maps/US_simplified/US-NW-PSEI.geojson'), //Puget Sound Energy
  readGeoJson('./third_party_maps/US_simplified/US-NW-SCL.geojson'), //Seattle City Light
  readGeoJson('./third_party_maps/US_simplified/US-NW-TPWR.geojson'), //City Of Tacoma, Department Of Public Utilities, Light Division
  readGeoJson('./third_party_maps/US_simplified/US-NW-WACM.geojson'), //Western Area Power Administration - Rocky Mountain Region
  readGeoJson('./third_party_maps/US_simplified/US-NW-WAUW.geojson'), //Western Area Power Administration Ugp West
  readGeoJson('./third_party_maps/US_simplified/US-NW-WWA.geojson'), //Naturener Wind Watch, Llc
  readGeoJson('./third_party_maps/US_simplified/US-NY-NYIS.geojson'), //New York Independent System Operator
  readGeoJson('./third_party_maps/US_simplified/US-SE-AEC.geojson'), //Powersouth Energy Cooperative
  ...
  readGeoJson('./third_party_maps/US_simplified/US-SW-TEPC.geojson'), //Tucson Electric Power Company
  readGeoJson('./third_party_maps/US_simplified/US-SW-WALC.geojson'), //Western Area Power Administration - Desert Southwest Region
  readGeoJson('./third_party_maps/US_simplified/US-TEN-TVA.geojson'), //Tennessee Valley Authority
  readGeoJson('./third_party_maps/US_simplified/US-TEX-ERCO.geojson'), //Electric Reliability Council Of Texas, Inc.
]);

const USOriginalGeos = [].concat([
  readGeoJson('./third_party_maps/US/US-CAL-BANC.geojson'), //Balancing Authority Of Northern California
  readGeoJson('./third_party_maps/US/US-CAL-CISO.geojson'), //California Independent System Operator
  readGeoJson('./third_party_maps/US/US-CAL-IID.geojson'), //Imperial Irrigation District
  readGeoJson('./third_party_maps/US/US-CAL-LDWP.geojson'), //Los Angeles Department Of Water And Power
  readGeoJson('./third_party_maps/US/US-CAL-TIDC.geojson'), //Turlock Irrigation District
  readGeoJson('./third_party_maps/US/US-CAR-CPLE.geojson'), //Duke Energy Progress East
  readGeoJson('./third_party_maps/US/US-CAR-CPLW.geojson'), //Duke Energy Progress West
  readGeoJson('./third_party_maps/US/US-CAR-DUK.geojson'), //Duke Energy Carolinas
  readGeoJson('./third_party_maps/US/US-CAR-SC.geojson'), //South Carolina Public Service Authority
  readGeoJson('./third_party_maps/US/US-CAR-SCEG.geojson'), //South Carolina Electric & Gas Company
  readGeoJson('./third_party_maps/US/US-CAR-YAD.geojson'), //Alcoa Power Generating, Inc. - Yadkin Division
  readGeoJson('./third_party_maps/US/US-CENT-SPA.geojson'), //Southwestern Power Administration
  readGeoJson('./third_party_maps/US/US-CENT-SWPP.geojson'), //Southwest Power Pool
  readGeoJson('./third_party_maps/US/US-FLA-FMPP.geojson'), //Florida Municipal Power Pool
  readGeoJson('./third_party_maps/US/US-FLA-FPC.geojson'), //Duke Energy Florida Inc
  readGeoJson('./third_party_maps/US/US-FLA-FPL.geojson'), //Florida Power & Light Company
  ...
  readGeoJson('./third_party_maps/US/US-NW-AVA.geojson'), //Avista Corporation
  readGeoJson('./third_party_maps/US/US-NW-BPAT.geojson'), //Bonneville Power Administration
  readGeoJson('./third_party_maps/US/US-NW-CHPD.geojson'), //Public Utility District No. 1 Of Chelan County
  readGeoJson('./third_party_maps/US/US-NW-DOPD.geojson'), //Pud No. 1 Of Douglas County
  readGeoJson('./third_party_maps/US/US-NW-GCPD.geojson'), //Public Utility District No. 2 Of Grant County, Washington
  readGeoJson('./third_party_maps/US/US-NW-GRID.geojson'), //Gridforce Energy Management, Llc
  readGeoJson('./third_party_maps/US/US-NW-GWA.geojson'), //Naturener Power Watch, Llc (Gwa)
  readGeoJson('./third_party_maps/US/US-NW-IPCO.geojson'), //Idaho Power Company
  readGeoJson('./third_party_maps/US/US-NW-NEVP.geojson'), //Nevada Power Company
  readGeoJson('./third_party_maps/US/US-NW-NWMT.geojson'), //Northwestern Energy (Nwmt)
  readGeoJson('./third_party_maps/US/US-NW-PACE.geojson'), //Pacificorp - East
  readGeoJson('./third_party_maps/US/US-NW-PACW.geojson'), //Pacificorp - West
  readGeoJson('./third_party_maps/US/US-NW-PGE.geojson'), //Portland General Electric Company
  readGeoJson('./third_party_maps/US/US-NW-PSCO.geojson'), //Public Service Company Of Colorado
  readGeoJson('./third_party_maps/US/US-NW-PSEI.geojson'), //Puget Sound Energy
  readGeoJson('./third_party_maps/US/US-NW-SCL.geojson'), //Seattle City Light
  readGeoJson('./third_party_maps/US/US-NW-TPWR.geojson'), //City Of Tacoma, Department Of Public Utilities, Light Division
  readGeoJson('./third_party_maps/US/US-NW-WACM.geojson'), //Western Area Power Administration - Rocky Mountain Region
  readGeoJson('./third_party_maps/US/US-NW-WAUW.geojson'), //Western Area Power Administration Ugp West
  readGeoJson('./third_party_maps/US/US-NW-WWA.geojson'), //Naturener Wind Watch, Llc
  readGeoJson('./third_party_maps/US/US-NY-NYIS.geojson'), //New York Independent System Operator
  readGeoJson('./third_party_maps/US/US-SE-AEC.geojson'), //Powersouth Energy Cooperative
  readGeoJson('./third_party_maps/US/US-SE-SEPA.geojson'), //Southeastern Power Administration
  readGeoJson('./third_party_maps/US/US-SE-SOCO.geojson'), //Southern Company Services, Inc. - Trans
  readGeoJson('./third_party_maps/US/US-SW-AZPS.geojson'), //Arizona Public Service Company
  ...
  readGeoJson('./third_party_maps/US/US-SW-TEPC.geojson'), //Tucson Electric Power Company
  readGeoJson('./third_party_maps/US/US-SW-WALC.geojson'), //Western Area Power Administration - Desert Southwest Region
  readGeoJson('./third_party_maps/US/US-TEN-TVA.geojson'), //Tennessee Valley Authority
  readGeoJson('./third_party_maps/US/US-TEX-ERCO.geojson'), //Electric Reliability Council Of Texas, Inc.
]);
...
const zoneDefinitions = [
  ...
  },
  {
    ...
    type: 'states',
    countryId: 'BRA',
    states: ['BR.AM', 'BR.PA', 'BR.TO', 'BR.RR', 'BR.AP'],
  },
  {
    zoneName: 'BR-NE',
    type: 'states',
    countryId: 'BRA',
    states: ['BR.PE', 'BR.MA', 'BR.CE', 'BR.PI', 'BR.AL', 'BR.BA', 'BR.PB', 'BR.RN', 'BR.SE'],
  },
  ...
  { zoneName: 'JP-CB', type: 'subZone', id: 'JP-CB' },
  {
    zoneName: 'JP-CG',
    type: 'administrations',
    administrations: ['JPN-1824', 'JPN-1826', 'JPN-1825', 'JPN-1822', 'JPN-1821'],
  },
  ...
  { zoneName: 'JP-ON', type: 'subZone', id: 'JP-ON' },
  {
    zoneName: 'JP-SK',
    type: 'administrations',
    administrations: ['JPN-1836', 'JPN-1833', 'JPN-1832', 'JPN-1834'],
  },
  {
    zoneName: 'JP-TH',
    type: 'administrations',
  ...
  { zoneName: 'MX-BC', type: 'administrations', administrations: ['MEX-2706', 'MEX-2707'] },
  {
    zoneName: 'MX-CE',
    type: 'administrations',
    administrations: ['MEX-2724', 'MEX-2726', 'MEX-2727', 'MEX-2732'],
  },
  { zoneName: 'MX-NW', type: 'administrations', administrations: ['MEX-2711', 'MEX-2712'] },
  {
    zoneName: 'MX-NO',
    type: 'administrations',
    administrations: ['MEX-2708', 'MEX-2709', 'MEX-2710'],
  },
  ...
  },
  {
    zoneName: 'MX-OR',
    type: 'administrations',
    administrations: ['MEX-2723', 'MEX-2725', 'MEX-2729', 'MEX-2734', 'MEX-2735'],
  },
  {
    zoneName: 'MX-PN',
    type: 'administrations',
    administrations: ['MEX-2722', 'MEX-2736', 'MEX-2737'],
  },
  ...
  },
  {
    zoneName: 'RU-EU',
    type: 'administrations',
    administrations: ['RUS-2354', 'RUS-2383', 'RUS-2381'],
  },
  {
    zoneName: 'RU-AS',
    type: 'administrations',
    administrations: ['RUS-2609', 'RUS-2611', 'RUS-2612', 'RUS-2613', 'RUS-2614'],
  },
  {
    zoneName: 'RU-FE',
    type: 'administrations',
    administrations: ['RUS-2321', 'RUS-2615', 'RUS-2616', 'RUS-3468'],
  },
